  ...
  render() {
    ...
    return (
      <SubscribeSection mt={4} pt={4}>
        ...
        <form name="subscribe" method="post" data-netlify="true" onSubmit={this.handleSubmit}>
          <Input type="email" name="email" required placeholder="you@email.com" width={250} onChange={this.handleChange} />
